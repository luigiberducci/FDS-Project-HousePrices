...
```
The street being Gravel or Paved greatly influences SalePrice.
...
In general, Utilities doesn't look like a good predictor, since all the house but one have AllPub utilities. Neither MiscVal can be considered as a strong predictor: few houses have MiscVal at most 2500 dollars, given the high rate of houses with no additional features, the value 0 for MiscVal is the most common.
